...
object RepositorioEquipos {
    ...
    // 1. Creamos el Mapa con las Divisiones y sus equipos
    val divisiones = mapOf(
        "AFC East" to listOf(
    ...
    // 2. Mantenemos 'listaEquipos' aplanando el mapa para que getEquipoById siga funcionando
    // flatten() convierte una lista de listas en una sola lista corrida
    val listaEquipos = divisiones.values.flatten()
